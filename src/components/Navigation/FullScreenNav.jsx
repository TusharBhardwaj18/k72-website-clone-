...
const FullScreenNav = () => {
  ...
  return (
    <div ref={fullscreenRef} id = 'fullscreennav' className=' text-white overflow-hidden  h-full w-full absolute z-50 bg-black'>
   ...
   <div ref={fullNavLinksRef} className='relative'>
    ...
    <div className='p-3'>
       ...
       <div className='h-20 w-20 top-1 right-2  absolute cursor-pointer z-50'>
